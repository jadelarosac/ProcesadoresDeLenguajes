...
{
       0,   152,   152,   152,   153,   154,   153,   181,   187,   191,
     192,   191,   221,   224,   225,   226,   227,   228,   229,   230,
     236,   238,   238,   249,   250,   257,   263,   263,   270,   270,
     281,   282,   290,   298,   310,   324,   330,   334,   349,   372,
     378,   379,   380,   387,   394,   401,   409,   417,   425,   432,
     433,   434,   436,   438,   440,   441,   455,   472,   576,   588,
     594,   605,   616,   633,   653,   659,   668,   669,   675,   687,
     688,   689,   690,   691,   693,   694,   695,   696,   697,   698,
     699,   700,   701,   702,   703,   704,   705,   706,   712,   718,
     795,   796,   809,   809,   826,   827,   828,   829,   838,   846,
     893,   918,   932,   940
};
#endif
...
#line 1658 "y.tab.c"
  ...
  case 3:
#line 152 "analizador_yacc.y"
                                                                       {if (n_errores == 0) {fputs(yyvsp[0].codigo,intermain);}finalizarGEN();}
#line 1664 "y.tab.c"
    break;
...
#line 1725 "y.tab.c"
  ...
  case 9:
#line 191 "analizador_yacc.y"
                              {anidado_nivel++;}
#line 1731 "y.tab.c"
    break;

  case 10:
#line 192 "analizador_yacc.y"
                              {subprog = 1;}
#line 1737 "y.tab.c"
    break;

  case 11:
#line 193 "analizador_yacc.y"
                              {
                                                                          if (n_errores == 0){
...
#line 1769 "y.tab.c"
  ...
  case 12:
#line 223 "analizador_yacc.y"
                                                             {if (n_errores == 0) mystrcpy(&yyval.codigo,&yyvsp[-1].codigo);}
#line 1775 "y.tab.c"
    break;

  case 13:
#line 224 "analizador_yacc.y"
                                  {paux = strdup("");mystrcpy(&yyval.codigo,&paux);}
#line 1781 "y.tab.c"
    break;
...
#line 1792 "y.tab.c"
  ...
  case 20:
#line 236 "analizador_yacc.y"
                                                        {if (n_errores == 0){ paux = strdup(yyvsp[0].codigo);
                              mystrcpy(&yyval.codigo,&paux);}}
#line 1799 "y.tab.c"
    break;
...
#line 249 "analizador_yacc.y"
                                      {paux = strdup(""); mystrcpy(&yyval.codigo,&paux);paux = strdup(""); mystrcpy(&yyval.nombreTmp,&paux);n_errores = n_errores+1;}
#line 1827 "y.tab.c"
    break;

  case 24:
#line 250 "analizador_yacc.y"
                                                                       {
...
#line 2033 "y.tab.c"
  ...
  case 40:
#line 378 "analizador_yacc.y"
                                            {if (n_errores == 0) mystrcpy(&yyval.codigo, &yyvsp[0].codigo);}
#line 2039 "y.tab.c"
    break;

  case 41:
#line 379 "analizador_yacc.y"
                                     {if (n_errores==0) mystrcpy(&yyval.codigo,&yyvsp[0].codigo);}
#line 2045 "y.tab.c"
    break;

  case 42:
#line 380 "analizador_yacc.y"
                                                       {
                                                                          if (n_errores == 0){
...
#line 2450 "y.tab.c"
  ...
  case 66:
#line 668 "analizador_yacc.y"
                                       {paux = strdup(""); mystrcpy(&yyval.codigo,&paux);paux = strdup(""); mystrcpy(&yyval.nombreTmp,&paux);n_errores = n_errores+1;}
#line 2456 "y.tab.c"
    break;

  case 67:
#line 669 "analizador_yacc.y"
...
#line 2514 "y.tab.c"
  ...
  case 74:
#line 693 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2520 "y.tab.c"
    break;

  case 75:
#line 694 "analizador_yacc.y"
                                                              {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2526 "y.tab.c"
    break;

  case 76:
#line 695 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2532 "y.tab.c"
    break;

  case 77:
#line 696 "analizador_yacc.y"
                                                           {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2538 "y.tab.c"
    break;
...
#line 2544 "y.tab.c"
  ...
  case 79:
#line 698 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2550 "y.tab.c"
    break;

  case 80:
#line 699 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2556 "y.tab.c"
    break;

  case 81:
#line 700 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2562 "y.tab.c"
    break;

  case 82:
#line 701 "analizador_yacc.y"
                                                             {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2568 "y.tab.c"
    break;

  case 83:
#line 702 "analizador_yacc.y"
                                                           {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2574 "y.tab.c"
    break;

  case 84:
#line 703 "analizador_yacc.y"
                                                            {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorBin(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2580 "y.tab.c"
    break;

  case 85:
#line 704 "analizador_yacc.y"
...
#line 2586 "y.tab.c"
  ...
  case 86:
#line 705 "analizador_yacc.y"
                                                              {yyval = procesaOperacionBinariaOMixta(yyvsp[-2],yyvsp[0],yyvsp[-1].atrib);genCodigoOperadorMix(&yyval,&yyvsp[-2],&yyvsp[0],yyvsp[-1].atrib);}
#line 2592 "y.tab.c"
    break;

  case 87:
#line 706 "analizador_yacc.y"
                                                     {yyval = yyvsp[0];
                                                                          if (n_errores == 0){
                              mystrcpy(&yyval.nombreTmp,&yyvsp[0].nombreTmp);
                              mystrcpy(&yyval.codigo,&yyvsp[0].codigo);
...
#line 2696 "y.tab.c"
  ...
  case 90:
#line 795 "analizador_yacc.y"
                                       {paux = strdup(""); mystrcpy(&yyval.codigo,&paux);paux = strdup(""); mystrcpy(&yyval.nombreTmp,&paux);n_errores = n_errores+1;}
#line 2702 "y.tab.c"
    break;

  case 91:
#line 796 "analizador_yacc.y"
...
#line 2747 "y.tab.c"
  ...
  case 94:
#line 826 "analizador_yacc.y"
                                     {yyval.atrib = yyvsp[0].atrib;}
#line 2753 "y.tab.c"
    break;

  case 95:
#line 827 "analizador_yacc.y"
                                     {paux = strdup(yyvsp[0].lexema);if (n_errores == 0) mystrcpy(&yyval.codigo,&paux);}
#line 2759 "y.tab.c"
    break;

  case 96:
#line 828 "analizador_yacc.y"
                                    {paux = strdup(yyvsp[0].lexema);if (n_errores == 0) mystrcpy(&yyval.codigo,&paux);}
#line 2765 "y.tab.c"
    break;

  case 97:
#line 829 "analizador_yacc.y"
